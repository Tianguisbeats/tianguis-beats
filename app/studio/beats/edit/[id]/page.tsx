                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted font-bold uppercase tracking-widest text-[10px] flex items-center gap-2">
                                    <Zap size={12} className="text-amber-400 fill-amber-400" /> Edita los detalles de "{title}"
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <form onSubmit={handleUpdate} className="space-y-10">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    {/* WAV (Updated for Pro Button Visibility) */}
                                    ...
                                    {/* STEMS (Updated for Premium Button Visibility) */}
                                ...
                                {/* Licencia Exclusiva Full Width (Updated for Premium Button Visibility) */}
