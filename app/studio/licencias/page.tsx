...
const CONTRACT_TYPES = [
    ...
    },
    {
        ...
        tier: 'TRACKOUTS',
        description: 'Máximo control · Incluye STEMS.',
        icon: <Crown size={26} />,
        color: 'text-blue-400',
    ...
    },
    {
        ...
        tier: 'SAMPLES',
        description: 'Términos de uso para venta de tus packs y librerías.',
        icon: <Layers size={26} />,
...
export default function ContractsPage() {
    ...
    const getDefaultLegalText = (type: ContractType) => {
        const defaults: Record<string, string> = {
            ...
            mp3: "LICENCIA BÁSICA: Derechos no exclusivos con descarga de archivo MP3 de alta calidad (HQ).",
            pro: "LICENCIA PRO: Derechos no exclusivos con limites extendidos de distribución (MP3 + WAV).",
            premium: "LICENCIA PREMIUM: Derechos no exclusivos con calidad de estudio profesional (WAV + STEMS).",
            ilimitada: "LICENCIA ILIMITADA: Derechos no exclusivos sin limites comerciales.",
            exclusiva: "LICENCIA EXCLUSIVA: Cesión total de derechos exclusivos sobre el instrumental.",
            soundkit: "LICENCIA SOUND KIT: Concede el uso no exclusivo de los audios contenidos en esta librería para integrarlos en obras musicales propias, quedando prohibida su re-venta individual.",
        };
