                    ...
                    <form onSubmit={sendMessage} className="p-6 bg-background/50 border-t border-border/30">
                        <div className="relative flex items-center">
                            ...
                            <button
                                ...
                                className="absolute right-2 w-11 h-11 bg-accent text-white rounded-[1rem] flex items-center justify-center hover:scale-105 active:scale-95 transition-all text-background disabled:opacity-50 disabled:scale-100"
                            >
                                <Send size={18} />
                            </button>
                        </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-card border border-border rounded-[2.5rem] p-8">
                        ...
                        {isBuyer && (
                            <div className="space-y-4">
                                {project.estado === 'paid' && (
                                    <button className="w-full p-4 bg-accent text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:scale-[1.02] transition-all">
                                ...
                                {project.estado === 'delivered' && (
                                    <div className="space-y-3">
                                        <button
                                            ...
                                            className="w-full p-4 bg-success text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all"
                                        >
                                            Aceptar y Finalizar
                                        </button>
                                        <button
                    ...
                    <div className="bg-card border border-border rounded-[2.5rem] p-8 max-h-[400px] overflow-hidden flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto space-y-4 pr-2">
                            {files.length === 0 ? (
                                <p className="text-[10px] text-muted font-bold text-center py-10 opacity-40 uppercase tracking-widest">No hay archivos aún</p>
                            ) : (
                                files.map((file) => (
                                    <a
                                        key={file.id}
