          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 px-4 md:px-0">
            ...
            <Link href="/beats/catalog" className="group relative h-[500px] rounded-[3rem] overflow-hidden cursor-pointer border border-border hover:border-accent/40 transition-all duration-700 shadow-2xl hover:shadow-accent/10">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent flex flex-col items-center justify-end p-12 text-center">
                ...
                <p className="text-accent text-[10px] font-black uppercase tracking-[0.2em] opacity-0 group-hover:opacity-100 transition-all translate-y-4 group-hover:translate-y-0">EXPLORA TODO EL CATÁLOGO</p>
              </div>
            </Link>

            {/* Sound Kits Card */}
            <Link href="/sound-kits" className="group relative h-[500px] rounded-[3rem] overflow-hidden cursor-pointer border border-border hover:border-accent/40 transition-all duration-700 shadow-2xl hover:shadow-accent/10">
              <Image
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent flex flex-col items-center justify-end p-12 text-center">
                ...
                <p className="text-accent text-[10px] font-black uppercase tracking-[0.3em] opacity-0 group-hover:opacity-100 transition-all translate-y-4 group-hover:translate-y-0">Explorar Sonidos</p>
              </div>
            </Link>

            {/* Artists Card */}
            <Link href="/productores" className="group relative h-[500px] rounded-[3rem] overflow-hidden cursor-pointer border border-border hover:border-accent/40 transition-all duration-700 shadow-2xl hover:shadow-accent/10">
              <Image
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent flex flex-col items-center justify-end p-12 text-center">
                ...
                <p className="text-accent text-[10px] font-black uppercase tracking-[0.3em] opacity-0 group-hover:opacity-100 transition-all translate-y-4 group-hover:translate-y-0">Encuentra a tu favorito</p>
              </div>
            </Link>
          </div>
        </div>
