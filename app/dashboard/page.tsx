    ...
    const handleFileUpload = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const { error: dbError } = await supabase.from('beats').insert({
                ...
                etiqueta: tag,
                portada_url: null,
                precio_basica_mxn: parseFloat(price),
                ...
                es_exclusiva_estandar_activa: isExclusive
            });
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
                        <div>
                            ...
                            <p className="text-muted font-medium tracking-tight">Gestiona tus beats y sube material nuevo.</p>
                        </div>

                        <div className="flex items-center gap-4 bg-card p-3 rounded-2xl border border-border w-full md:w-auto">
                            ...
                            <div className="pr-4">
                                <p className="text-[10px] font-black uppercase tracking-widest text-muted leading-none mb-1">Plan Actual</p>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-8 bg-card rounded-[2.5rem] border border-border">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-[10px] font-bold text-muted italic">Estás en el plan más completo. ¡Sigue rompiendo!</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-2">
                            <form onSubmit={handleFileUpload} className="bg-card border-2 border-border rounded-[3rem] p-8 md:p-12 shadow-sm">
                                ...
                                <div className="space-y-8">
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-card border-2 border-border rounded-2xl px-6 py-4 outline-none focus:border-accent transition-all font-bold text-foreground placeholder:text-muted"
                                                required
                                            />
                                        </div>
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full bg-card border-2 border-border rounded-2xl px-6 py-4 outline-none focus:border-accent transition-all font-bold text-foreground appearance-none"
                                            >
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-card border-2 border-border rounded-2xl px-6 py-4 outline-none focus:border-accent transition-all font-bold text-foreground"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className={`w-full py-6 rounded-2xl font-black uppercase tracking-[0.2em] text-xs transition-all shadow-xl transform active:scale-95 flex items-center justify-center gap-3 ${isUploading ? 'bg-foreground/10 text-muted' : 'bg-accent text-white hover:bg-blue-700 shadow-accent/20'}`}
                                    >
                                        {isUploading ? (
                                            <>
