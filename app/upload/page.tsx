                    ...
                    <div className="w-full relative">
                        ...
                        <div className="relative pt-12 md:pt-20 pb-16 overflow-hidden">
                            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                                <div className="absolute top-0 right-1/2 translate-x-1/2 w-[300px] md:w-[500px] h-[300px] bg-blue-500/[0.04] rounded-full blur-[100px] md:-mt-10" />
                            </div>
                            ...
                            <div className="max-w-screen-2xl mx-auto px-6 sm:px-12 relative z-10 w-full flex flex-col items-center text-center">
                                <ScrollReveal direction="up" delay={0.05} className="flex flex-col items-center">
                                    <div className="flex items-center justify-center gap-3 mb-8 md:mb-12">
                                        <motion.div
                                            className="flex items-center gap-3 p-2 pr-4 rounded-full bg-blue-500/5 border border-blue-500/10"
                                        ...
                                        >
                                            ...
                                            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-blue-500">Tianguis Engine v4</span>
                                        </motion.div>
                                    </div>
                                    ...
                                    <h1 className="leading-[0.85] mb-10 relative z-10 uppercase font-black tracking-tighter flex flex-col items-center">
                                        <motion.span
                                            ...
                                            className="block text-4xl sm:text-6xl md:text-7xl lg:text-[6rem] text-foreground"
                                        >
                                            Sube Tu
                                        </motion.span>
                                        <motion.span
                                            ...
                                            className="block text-4xl sm:text-6xl md:text-7xl lg:text-[5.5rem] text-blue-500 dark:text-blue-400 italic pr-2"
                                        >
                                            Arte
                                        </motion.span>
                                    </h1>
