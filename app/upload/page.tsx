                    ...
                    <div className="w-full relative">
                        ...
                        <div className="relative pt-24 pb-24 overflow-hidden">
                            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                                <div className="absolute top-0 right-0 w-[300px] h-[200px] bg-yellow-400/[0.04] rounded-full blur-3xl -mr-10 -mt-10" />
                                <span className="absolute bottom-[-5%] right-[-3%] text-[22vw] font-black leading-none text-yellow-500/[0.04] tracking-tighter uppercase block whitespace-nowrap select-none">
                                    NUEVO
                                </span>
                            </div>
                                ...
                                <ScrollReveal direction="up" delay={0.05}>
                                    <div className="flex items-center gap-3 mb-16">
                                        ...
                                        >
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-[0.6em] text-yellow-500 dark:text-yellow-400">Tianguis Engine v4</span>
                                        </motion.div>
                                    </div>
                                    ...
                                    <h1 className="leading-[0.85] mb-8 relative z-10 uppercase font-black tracking-tighter">
                                        ...
                                        <motion.span
                                            ...
                                            className="block text-6xl md:text-8xl lg:text-[10rem] text-yellow-200"
                                        >
                                            Nuevo
                                        </motion.span>
                                        {/* LANZAMIENTO - ESTATICO */}
                                        <motion.span
                                            initial={{ opacity: 0, y: 30 }}
                                            animate={{ opacity: 1, y: 0 }}
