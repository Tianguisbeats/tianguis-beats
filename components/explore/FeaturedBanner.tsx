                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                if (beatToPlay.type === 'beat') {
                                                    // Ensure badge data is mapped correctly for AudioPlayer
                                                    const mappedBeat = {
                                                        ...beatToPlay,
                                                        productor_esta_verificado: beatToPlay.productor_esta_verificado || (beatToPlay.producer?.esta_verificado),
                                                        productor_es_fundador: beatToPlay.productor_es_fundador || (beatToPlay.producer?.es_fundador)
                                                    };
                                                    playBeat(mappedBeat as any);
                                                }
                                            }}
