        ...
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4">
            ...
            <div className="relative bg-card w-full sm:max-w-md rounded-t-[2.5rem] sm:rounded-[2.5rem] shadow-2xl border border-border border-b-0 sm:border-b flex flex-col overflow-hidden">
                ...
                <div className="p-6 sm:p-8 space-y-5">
                    ...
                    {/* Info note */}
                    <p className="text-[9px] text-muted font-bold uppercase tracking-widest opacity-60 leading-relaxed px-2 text-center bg-foreground/[0.03] py-3 rounded-xl border border-dashed border-border/50">
                        💡 Los Beats se agregan directamente desde la tarjeta del Beat (botón +) o desde el explorador.
                    </p>
                </div>
