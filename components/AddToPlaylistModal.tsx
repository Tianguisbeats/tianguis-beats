                ...
                <div className="p-6 sm:p-8 flex items-center justify-between border-b border-border">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[9px] font-bold text-muted uppercase tracking-widest mt-0.5">Añade o quita este beat de tus colecciones</p>
                        </div>
                    </div>
                ...
                <div className="p-6 sm:p-8 max-h-[60vh] overflow-y-auto no-scrollbar">
                    {loading ? (
                        ...
                        <div className="py-12 text-center space-y-4">
                            ...
                            <p className="text-[10px] font-bold text-muted uppercase tracking-widest max-w-[200px] mx-auto">Crea una playlist desde tu perfil. Una vez creada, podrás añadir beats desde aquí o desde las tarjetas usando el botón (+).</p>
                        </div>
                    ) : (
